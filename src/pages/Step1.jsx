    ...
    <div >
      <div class='relative px-4 bottom-13 h-full'>
        <div class='flex  flex-col justify-between h-full bg-[var(--White)] h-full w-full border-0 rounded-xl px-6 py-8' >
            ...
            <div class='block'>
              <p class='text-base font-medium text-[var(--Grey500)]'>Please provide your name, email</p>
              <p class='text-base font-medium text-[var(--Grey500)]'>address, and phone number.</p>
            </div>
          <form onSubmit={handleSubmit(submit)}  >
            ...
            <div class='mt-2'>
              <label class='text-sm text-[var(--primaryBlue950)] font-medium' for='email'>Email Address</label>
              <input id='email' type='text' required placeholder='e.g stephenking@gmail.com'/>
            </div>
            <div class='mt-2'>
              <label class='text-sm text-[var(--primaryBlue950)] font-medium' for='phone_no'>Phone Number</label>
              <input  id='phone_no' type='text' placeholder=' e.g +1 234 567 890'></input>
            </div>
          </form>
        </div>
        <footer class='relative top-34 bg-[var(--White)] py-4 px-4 flex justify-end'>
